...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   move_charecter_bonus.c                             :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: wmozella <wmozella@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/01/18 20:28:23 by wmozella          #+#    #+#             */
/*   Updated: 2022/01/28 21:56:56 by wmozella         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_move_d(t_vars *vars)
{
	if (vars->map[vars->player_x][vars->player_y + 1] != '1')
	{
			...
			&& vars->count_c --)
		{
			...
			&& vars->count_c == 0)
			vars->ok = 1;
		else if (vars->map[vars->player_x][vars->player_y + 1] == 'A')
			vars->lose = 1;
		vars->player_y ++;
		printf ("Steps: %d\n", vars->steps);
	}
...
void	ft_move_w(t_vars *vars)
{
	if (vars->map[vars->player_x - 1][vars->player_y] != '1')
	{
			...
			&& vars->count_c --)
		{
			...
			&& vars->count_c == 0)
			vars->ok = 1;
		else if (vars->map[vars->player_x - 1][vars->player_y] == 'A')
			vars->lose = 1;
		vars->player_x--;
		printf ("Steps: %d\n", vars->steps);
	}
